...
#
5 # Number of datafiles to produce: 1st is input, 2nd is estimates, 3rd and higher are bootstrap, 0 turns off all *.ss_new output
2 # Turn off estimation for parameters entering after this phase
#
0 # MCeval burn interval
1 # MCeval thin interval
0 # jitter initial parm value by this fraction
-1 # min yr for sdreport outputs (-1 for styr); #_1925
-1 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2008
0 # N individual STD years 
#vector of year values 

1e-06 # final convergence criteria (e.g. 1.0e-04) 
...
# -1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1600185875
